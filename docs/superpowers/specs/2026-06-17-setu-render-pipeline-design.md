# Setu Render Pipeline (sub-project #1) — Design

> Sub-project #1 of the render/theme layer. Parent vision + decomposition:
> `docs/superpowers/specs/2026-06-17-setu-render-theme-vision.md`. Both render
...
**shipped** editor block to correct, static HTML — the first time Setu's authored content
...
See [[setu-project]] and the topology/publishing note
(`docs/superpowers/specs/2026-06-14-setu-topology-publishing-note.md`) — keep render a
