...
**Spec:** `docs/superpowers/specs/2026-06-14-setu-config-schema-design.md`
...
├── types.ts           # SetuConfig, BlockDefinition, BlockEditorMeta, ResolvedConfig, ResolvedBlock
...
- Public exports (`SetuConfig`, `BlockDefinition`, `BlockEditorMeta`, `ResolvedConfig`, `ResolvedBlock`, `defineConfig`, `resolveConfig`, `loadConfig`, `defaultConfig`, `defaultKnownBlockTags`) → incrementally across Tasks 1-5. ✓
