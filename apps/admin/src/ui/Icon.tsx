const ICONS = {
  ...
  panelRight:
    '<rect x="3" y="3" width="18" height="18" rx="2.4"/><path d="M15 3v18"/>',
  ...
  listOrdered:
    '<path d="M10 6h11M10 12h11M10 18h11"/><path d="M4 4.5 5.2 4v4M3.6 16.5h1.8L3.6 19h2"/>',
  quote:
    '<path d="M9 7H6a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h2a1 1 0 0 1 1 1v1a2 2 0 0 1-2 2"/><path d="M20 7h-3a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h2a1 1 0 0 1 1 1v1a2 2 0 0 1-2 2"/>',
  callout:
    '<path d="M12 2a7 7 0 0 0-4 12.7V17a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-2.3A7 7 0 0 0 12 2z"/><path d="M9.5 21h5"/>',
  divider:
    '<path d="M3 12h18"/><path d="M6 8h.01M10 8h.01M14 8h.01M18 8h.01M6 16h.01M10 16h.01M14 16h.01M18 16h.01"/>',
  ...
  video:
    '<rect x="2" y="6" width="14" height="12" rx="2.4"/><path d="m22 8-6 4 6 4z"/>',
  user: '<circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/>',
  users:
    '<circle cx="9" cy="8" r="3.5"/><path d="M2.5 21a6.5 6.5 0 0 1 13 0"/><path d="M16 5.2a3.5 3.5 0 0 1 0 6.6M22 21a6.5 6.5 0 0 0-5-6.3"/>',
  calendar:
    '<rect x="3" y="4.5" width="18" height="16" rx="2.4"/><path d="M3 9.5h18M8 2.5v4M16 2.5v4"/>',
  ...
  rocket:
    '<path d="M5 15c-1.5 1.3-2 5-2 5s3.7-.5 5-2c.7-.8.7-2 0-2.8a2 2 0 0 0-3 0z"/><path d="M9 13c4-1 8-5 9-10-5 1-9 5-10 9z"/><path d="M14 6.5a8 8 0 0 1 3.5 3.5"/>',
  gitBranch:
    '<circle cx="6" cy="6" r="2.5"/><circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="8" r="2.5"/><path d="M6 8.5v7M18 10.5c0 4-6 2-6 5"/>',
  terminal:
    '<rect x="3" y="4" width="18" height="16" rx="2.4"/><path d="m8 9 3 3-3 3M13 15h4"/>',
  ...
  languages:
    '<path d="M2 5h9M6.5 3v2c0 4-2 6.5-4.5 7.5"/><path d="M4 9c0 2.5 3 4.5 5 5.5"/><path d="m12 20 4.5-10 4.5 10M13.5 16h6"/>',
  trash:
  ...
  subscript:
    '<path d="M4 7l9 10M13 7l-9 10"/><path d="M21 20h-4v-1l3-2.5a1.5 1.5 0 0 0-2.5-1.5"/>',
  superscript:
    '<path d="M4 8l9 10M13 8l-9 10"/><path d="M21 8h-4V7l3-2.5A1.5 1.5 0 0 0 17.5 3"/>',
  ...
  palette:
    '<path d="M12 2a10 10 0 1 0 0 20 1.7 1.7 0 0 0 1.7-1.7c0-.5-.2-.9-.5-1.2a1.7 1.7 0 0 1 1.2-2.9H17a5 5 0 0 0 5-5 9 9 0 0 0-10-9z"/><circle cx="8" cy="8" r="1"/><circle cx="12.5" cy="6.5" r="1"/><circle cx="16" cy="9.5" r="1"/>',
  keyboard:
    '<rect x="2.5" y="6" width="19" height="12" rx="2"/><path d="M6 9.5h.01M9.5 9.5h.01M13 9.5h.01M16.5 9.5h.01M6 13h.01M16.5 13h.01M9 13h6"/>',
  ...
  rowAdd:
    '<rect x="3" y="4" width="18" height="6" rx="1.5"/><path d="M12 14v6M9 17h6"/>',
  rowDelete:
    '<rect x="3" y="4" width="18" height="6" rx="1.5"/><path d="M9 17h6"/>',
  columnAdd:
    '<rect x="4" y="3" width="6" height="18" rx="1.5"/><path d="M17 9v6M14 12h6"/>',
  columnDelete:
    '<rect x="4" y="3" width="6" height="18" rx="1.5"/><path d="M14 12h6"/>'
} as const
