# Setu Block Component Package (sub-project #2) — Design

> Sub-project #2 of the render/theme epic. Parent vision:
> `docs/superpowers/specs/2026-06-17-setu-render-theme-vision.md`
...
See [[setu-project]], the parent vision doc, and
`docs/superpowers/specs/2026-06-17-setu-render-pipeline-design.md`.
