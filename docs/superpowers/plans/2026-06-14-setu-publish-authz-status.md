...
**Tech Stack:** React 18, Tiptap v3, the in-browser ports (db-memory + git-memory), zod, Vitest. Design refs: `docs/superpowers/specs/2026-06-14-setu-publish-deploy-design.md` + `...-rbac-design.md`.
