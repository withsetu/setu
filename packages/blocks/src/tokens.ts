...
export const BLOCK_TOKENS: readonly BlockToken[] = [
  { name: '--accent', axis: 'accent', description: 'Primary brand / action color' },
  { name: '--accent-strong', axis: 'accent', description: 'Darker accent (hover, emphasis)' },
  { name: '--accent-soft', axis: 'accent', description: 'Tinted accent surface' },
  { name: '--on-accent', axis: 'accent', description: 'Foreground on an accent fill' },
  { name: '--bg', axis: 'surface', description: 'Page background' },
  { name: '--surface-2', axis: 'surface', description: 'Raised/secondary surface' },
  ...
  { name: '--font-ui', axis: 'typography', description: 'UI / block font family' }
] as const

export const TOKENS_BY_AXIS: Record<BlockStyleAxis, string[]> = BLOCK_TOKENS.reduce(
  (acc, t) => {
