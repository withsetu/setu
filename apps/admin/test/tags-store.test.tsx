    ...
    const data = createMemoryDataPort([
      {
        ...
        metadata: { title: 'A', tags: ['react'] }
      },
      {
        collection: 'post',
        locale: 'en',
        slug: 'b',
        content: doc('b') as any,
    ...
    const data = createMemoryDataPort([
      {
        ...
        slug: 'a',
        content: doc('a') as any,
        metadata: { title: 'A', tags: ['react', 'reactjs'] }
      },
      {
        collection: 'post',
        locale: 'en',
