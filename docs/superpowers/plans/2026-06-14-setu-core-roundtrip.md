...
**Goal:** Stand up the Setu monorepo and port the proven Markdoc⇄Tiptap round-trip spike into `@setu/core` as typed, test-covered TypeScript.
...
**Spec:** `docs/superpowers/specs/2026-06-14-setu-core-roundtrip-design.md`
...
git commit -m "chore: scaffold Setu monorepo (Node + pnpm + Vitest) with @setu/core"
```
