...
```bash
DIR=$(find /Users/mayank/Documents/projects/setu/node_modules/.pnpm -path '*@tiptap+extension-text-align@3.26.1*/node_modules/@tiptap/extension-text-align/dist' -type d | head -1)
