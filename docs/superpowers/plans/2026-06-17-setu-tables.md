...
Run: `cd /Users/mayank/Documents/projects/setu/.claude/worktrees/<this-worktree> && pnpm install`
...
node -e "const t=require('@tiptap/extension-table'); console.log(Object.keys(t))" 2>/dev/null \
  || grep -rhoE '\b(TableKit|Table|TableRow|TableCell|TableHeader)\b' \
       $(find /Users/mayank/Documents/projects/setu/node_modules/.pnpm -path '*@tiptap+extension-table@*/node_modules/@tiptap/extension-table/dist/index.d.ts' | head -1) | sort -u
```
...
```css
/* ---- Tables ---- */
.setu-prose table { border-collapse: collapse; width: 100%; margin: 12px 0; font-size: 16px; table-layout: fixed; overflow: hidden; }
.setu-prose th, .setu-prose td { border: 1px solid var(--border-strong); padding: 8px 11px; vertical-align: top; position: relative; }
.setu-prose th { background: var(--bg-sunken); font-weight: 650; text-align: left; }
.setu-prose th > p, .setu-prose td > p { margin: 0; padding: 0; font-size: 16px; line-height: 1.5; }
.setu-prose th[style*="center"], .setu-prose td[style*="center"] { text-align: center; }
.setu-prose th[style*="right"], .setu-prose td[style*="right"] { text-align: right; }
.setu-prose .selectedCell::after { content: ""; position: absolute; inset: 0; background: color-mix(in oklch, var(--accent) 14%, transparent); pointer-events: none; }
/* table action menu */
