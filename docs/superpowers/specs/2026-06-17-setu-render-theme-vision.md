# Setu Render Pipeline & Theme Layer — Vision & Decomposition
...
- **AI / MCP is an accelerant, not the identity.** Repositioning the product around "AI
  ...
  exposes the component contract so any AI can scaffold a correct Setu component is smart
...
future marketplace (`pnpm add @someone/setu-…`), and contracts are the stability boundary
...
Per Setu's working pattern (de-risk spike-class risk before speccing), the first action is
...
See [[setu-project]], [[setu-wedge]], [[setu-working-style]], and the topology/publishing
note (`docs/superpowers/specs/2026-06-14-setu-topology-publishing-note.md`).
